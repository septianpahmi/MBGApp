                        ...
                        <div class="px-4">
                            <nav class="bg-white py-2 px-3 relative top-3 items-center rounded-lg flex z-10 shadow-md">
                                ...
                                <div class="flex flex-col justify-end ml-auto items-end">
                                    <h1 class="text-lg font-bold text-gray-800">{{ $beneficiaries->acceptance_count }}
                                    </h1>
                                ...
                                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex justify-between items-center mt-4 gap-2">
                                            @if ($todayMenu->status == 'Distributed')
                                                <button
                                            ...
                                            @else
                                                <button
                                                    class="bg-blue-200 w-full text-white text-sm font-bold py-2 px-4 rounded-lg">
                                                    Sudah Menerima
                                                </button>
                                            @endif
                                        ...
                                        <div
                                            ...
                                            <div class="flex justify-start flex-col">
                                                <h1 class="text-sm font-bold text-gray-800 ">
                                                    {{ $feedbacks->menu->title ?? 'Menu tidak ditemukan' }}</h1>
                                                <h1 class="text-xs font-semibold text-gray-800">
                    ...
                    <div x-transition>
                        ...
                        <section class="relative z-10 mb-4">
                            <div class="flex items-center relative h-[210px] top-0">
                                <div class="absolute flex flex-col p-4">
                                    <h1 class="text-gray-600 text-xl font-bold">Septian Pahmi</h1>
