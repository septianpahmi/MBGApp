            ...
            <di class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('kitchenUpdate', $kitchen->slug) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone"
                                                ...
                                                value="{{ old('phone', $kitchen->phone) }}" pattern="[0-9]*"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="address" name="address" placeholder="Masukkan Alamat" required>{{ old('address', $kitchen->address) }}</textarea>
