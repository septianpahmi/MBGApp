            ...
            <di class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('beneficiaryUpdate', $beneficiary->id) }}" method="POST"
                                ...
                                <div class="row">
                                            ...
                                            <select class="form-control" id="receiver_id" name="receiver_id" required>
                                                ...
                                                @foreach ($receivers as $receiver)
                                                    <option value="{{ $receiver->id }}"
                                                        {{ $beneficiary->receiver_id == $receiver->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="address" name="address" placeholder="Masukkan Alamat" required>{{ $beneficiary->address }}</textarea>
